...
import { ServiceCard, ServicesContainer, CardContainer } from "./Services-style";
            ...
            <CardContainer>
                <ServiceCard>
                    <div className="contentContainer">
                        ...
                        <p className="description">quisque suscipit	per quisque suscipita ptent fusce dictum porttitor auctor suscipit a adipiscing quisque suscipit.</p>
